...
<div id="main" class="wrap">
    ...
    <div class="main">
        <h2>修改商品</h2>
        <div class="manage">
            <form action="manage/user?action=updateProduct" method="post" enctype="multipart/form-data">
                <input type="hidden" name="id" value="${requestScope.product.id}">
                <input type="hidden" name="childId" value="${requestScope.product.childId}">
                <table class="form">
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="parentId">
                                ...
                                <option value="${cate.epcID}"
                                    ${requestScope.product.pcId == cate.epcID ? "selected='selected'" :""}>
                                        ${cate.epcName}
                                </option>
                                </c:forEach>
                            </select>
                    ...
                    <tr>
                        ...
                        <td><input type="text" class="text" name="description"
                                   value="${requestScope.product.description}"/></td>
                    </tr>
                    <tr>
                        <td class="field">库存：</td>
                        <td><input type="text" class="text tiny" name="stock"
                                   value="${requestScope.product.stock}"/></td>
                    </tr>
                    <tr>
