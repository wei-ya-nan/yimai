...
<div id="main" class="wrap">
	...
	<div class="main">
		<h2>回复留言</h2>
		<div class="manage">
			<form action="manage/order?action=replay" method="post">
				<table class="form">
					<tr>
						<td class="field">留言ID：</td>
						<td><input type="text" class="text" name="orderId" value="${requestScope.comment.ecId}"
								   readonly="readonly" /></td>
					</tr>
					<tr>
						<td class="field">留言姓名：</td>
						<td><input type="text" class="text" name="name" value="${requestScope.comment.name}" /></td>
					</tr>
					<tr>
						<td class="field">留言内容：</td>
						<td name="content">${requestScope.comment.content}</td>
					</tr>
					<tr>
